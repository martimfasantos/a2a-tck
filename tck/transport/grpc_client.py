"""gRPC Transport Client wrapping a2a-python SDK BaseClient."""
...
class GRPCClient(BaseTransportClient):
    """gRPC transport client wrapping SDK BaseClient."""
    ...
    def __init__(
        ...
        super().__init__(base_url, TransportProtocol.GRPC)
    ...
    def _initialize_sdk_client(self):
        ...
        self._logger.info(f"Initialized gRPC client for {self._agent_card.name}")
