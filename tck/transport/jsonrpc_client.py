"""JSON-RPC Transport Client wrapping a2a-python SDK BaseClient."""
...
class JSONRPCClient(BaseTransportClient):
    """JSON-RPC transport client wrapping SDK BaseClient."""
    ...
    def __init__(
        ...
        super().__init__(base_url, TransportProtocol.JSONRPC)
    ...
    def _initialize_sdk_client(self):
        ...
        self._logger.info(f"Initialized JSON-RPC client for {self._agent_card.name}")
