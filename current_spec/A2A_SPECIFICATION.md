...
| `context_id` | `string`                              | Yes      | Server generated ID for contextual alignment across interactions              |
...
| `referencetask_ids` | `string[]`                      | No       | List of tasks referenced as contextual hint by this message.                     |
| `message_id`        | `string`                        | Yes      | Message identifier generated by the message sender                               |
| `task_id`           | `string`                        | No       | Task identifier the current message is related to                                |
| `context_id`        | `string`                        | No       | Context identifier the message is associated with                                |
...
| Field Name               | Type                                                          | Required | Description                                                                                                                           |
| :----------------------- | :------------------------------------------------------------ | :------- | :------------------------------------------------------------------------------------------------------------------------------------ |
| `task_id`                 | `string`                                                      | Yes      | The ID of the task to configure push notifications for, or retrieve configuration from.                                               |
...
| Field Name  | Type                                  | Required | Default         | Description                                                                                                                                      |
| :---------- | :------------------------------------ | :------- | :-------------- | :----------------------------------------------------------------------------------------------------------------------------------------------- |
| `task_id`    | `string`                              | Yes      |                 | Task ID being updated                                                                                                                            |
| `context_id` | `string`                              | Yes      |                 | Context ID the task is associated with                                                                                                           |
...
| Field Name  | Type                              | Required | Default           | Description                                                                |
| :---------- | :-------------------------------- | :------- | :---------------- | :------------------------------------------------------------------------- |
| `task_id`    | `string`                          | Yes      |                   | Task ID associated with the generated artifact part                        |
| `context_id` | `string`                          | Yes      |                   | Context ID the task is associated with                                     |
...
- **Request `params` type**: [`task_idParams`](#741-task_idparams-object-for-taskscancel-and-taskspushnotificationconfigget)
...
#### 7.4.1. `task_idParams` Object (for `tasks/cancel` and `tasks/pushNotificationConfig/get`)

A simple object containing just the task ID and optional metadata.

```ts { .no-copy }
--8<-- "types/src/types.ts:task_idParams"
```
...
- **Request `params` type**: [`GetTaskPushNotificationConfigParams`](#761-gettaskpushnotificationconfigparams-object-taskspushnotificationconfigget) | [`task_idParams`](#741-task_idparams-object-for-taskscancel-and-taskspushnotificationconfigget)
_(Note: task_idParams type is deprecated for this method. Use GetTaskPushNotificationConfigParams instead.)_
...
- **Request `params` type**: [`task_idParams`](#731-taskqueryparams-object)
   ...
   ```json
   {
     ...
     "params": {
       "message": {
         ...
         "message_id": "9229e770-767c-417b-a0b0-f0741243c589"
       },
       "metadata": {}
     }
   }
...
2. **Server processes the request, creates a task and responds (task completes quickly)**
   ...
   ```json
   {
     ...
     "result": {
       ...
       "context_id": "c295ea44-7543-4f78-b524-7a38915ad6e4",
       "status": {
         "state": "completed"
       },
       "artifacts": [
       ...
       "history": [
         {
           ...
           "message_id": "9229e770-767c-417b-a0b0-f0741243c589",
           "task_id": "363422be-b0f9-4692-a24d-278670e7c7f1",
           "context_id": "c295ea44-7543-4f78-b524-7a38915ad6e4"
         }
       ],
       "kind": "task",
...
2. **Server processes the request, responds quickly without a task**
   ...
   ```json
   {
     ...
     "id": 1,
     "result": {
       "message_id": "363422be-b0f9-4692-a24d-278670e7c7f1",
       "context_id": "c295ea44-7543-4f78-b524-7a38915ad6e4",
       "parts": [
         {
           "kind": "text",
   ...
   ```json
   {
     ...
     "params": {
       "message": {
         ...
         "message_id": "bbb7dee1-cf5c-4683-8a6f-4114529da5eb"
       },
       "metadata": {}
     }
   }
...
2. **Server responds with HTTP 200 OK, `Content-Type: text/event-stream`, and starts sending SSE events:**
   ...
   data: {
     ...
     "result": {
       ...
       "context_id": "05217e44-7e9f-473e-ab4f-2c2dde50a2b1",
       "status": {
         "state": "submitted",
       ...
       "history": [
         {
           ...
           "message_id": "bbb7dee1-cf5c-4683-8a6f-4114529da5eb",
           "task_id": "225d6247-06ba-4cda-a08b-33ae35c8dcfa",
           "context_id": "05217e44-7e9f-473e-ab4f-2c2dde50a2b1"
         }
       ],
       "kind": "task",
...
1. **Client sends a message using `message/send`:**
   ...
   ```json
   {
     ...
     "params": {
       ...
       "message_id": "c53ba666-3f97-433c-a87b-6084276babe2"
     }
   }
   ```
     ...
     "result": {
       ...
       "status": {
         ...
         "message": {
           ...
           "message_id": "c2e1b2dd-f200-4b04-bc22-1b0c65a1aad2",
           "task_id": "3f36680c-7f37-4a5f-945e-d78981fafd36",
           "context_id": "c295ea44-7543-4f78-b524-7a38915ad6e4"
         },
   ...
   ```json
   {
     ...
     "params": {
       "message": {
         ...
         "context_id": "c295ea44-7543-4f78-b524-7a38915ad6e4",
         "task_id": "3f36680c-7f37-4a5f-945e-d78981fafd36",
         "message_id": "0db1d6c4-3976-40ed-b9b8-0043ea7a03d3"
       },
       "configuration": {
         "blocking": true
       }
   ...
   ```json
   {
     ...
     "params": {
       "message": {
         ...
         "message_id": "85b26db5-ffbb-4278-a5da-a7b09dea1b47"
       },
       "metadata": {}
     }
   }
