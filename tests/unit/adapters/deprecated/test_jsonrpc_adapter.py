...
class MockJSONRPCClient(JSONRPCClient):
    ...
    def __init__(self, base_url: str = "https://example.com/jsonrpc"):
        ...
        self.transport_type = TransportProtocol.jsonrpc
        self.call_log = []
        self.timeout = 30.0
        self.max_retries = 3
...
class TestJSONRPCTestAdapter:
    ...
    def test_context(self):
        ...
        return TestContext(
            transport_type=TransportProtocol.jsonrpc,
    ...
    def test_adapter_initialization(self, mock_client):
        ...
        assert adapter.transport_type == TransportProtocol.jsonrpc
    ...
    def test_initialization_with_wrong_client_type(self):
        ...
        wrong_client = Mock()
        wrong_client.transport_type = TransportProtocol.GRPC
    ...
    def test_send_message_success(self, adapter, test_context):
        ...
        assert result.transport_type == TransportProtocol.jsonrpc
    ...
    def test_error_handling_with_transport_error(self, adapter, test_context):
        ...
        adapter.jsonrpc_client.send_message = Mock(side_effect=TransportError("Network error", TransportProtocol.jsonrpc))
